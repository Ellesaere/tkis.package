table_maker_orginal <- function(table_in, strata_in = NULL) {
...
table_maker_warnings <- function(table_in, strata_in = NULL) {
...
table_maker_revision <- function(table_in, strata_in = NULL) {
